declare namespace gsap {
    ...
    export class TweenMax extends TweenLite {
        constructor(target: object | string, duration: number, vars: {});
        ...
        static from(target: object | string, duration: number, vars: {}): TweenMax;
        ...
        static fromTo(target: object | string, duration: number, fromVars: TweenConfig, toVars: TweenConfig): TweenMax;
        ...
        /** Returns an array containing all the tweens of a particular target (or group of targets) that have not been released for garbage collection yet which typically happens within a few seconds after the tween completes. */
        static getTweensOf(target: object | string): Tween[];
        ...
        static isTweening(target: object | string): boolean;
        ...
        static killTweensOf(target: object | string, vars?: {}): void;
        ...
        /** Immediately sets properties of the target accordingly - essentially a zero-duration to() tween with a more intuitive name. */
        static set(target: object | string, vars: {}): TweenMax;
